...
import FoSARAppsList from "./FoSARAppsList";
import FoApplicationTypeFilter from "../../../../common/search/filters/definition/FoApplicationTypeFilter";
import type { RootState } from "../../../../../../store/redux/store";
import { vFoBaseAppsFilterSchema } from "../../../../../../yup/schema/applications/common/schemas";

const FoSARApps = () => {
  const store = useStore();
  const group = SEARCH_FILTERS_GROUP.FO_SAR_APPLICATIONS;

  const { methods, handleSubmit } = useReactHookForm<FoApplicationFilterDetails>({
    defaultValues: foSarFilterInitialValues,
  ...
  const control = useSearchTableControl({
    group,
    methods,
    initialValues: foSarFilterInitialValues,
