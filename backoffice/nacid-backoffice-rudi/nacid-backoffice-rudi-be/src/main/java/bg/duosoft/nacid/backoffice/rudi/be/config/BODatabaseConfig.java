...
@EnableJpaRepositories(
        basePackages = {"bg.duosoft.nacid.backoffice.rudi.be.repository",
                // TODO:NACIDSE-16
                "bg.duosoft.nacid.backoffice.rudi.be.grading.scales.repository"},
        entityManagerFactoryRef = "boEntityManager",
        transactionManagerRef = "boTransactionManager"
)
@EnableTransactionManagement(order = Ordered.HIGHEST_PRECEDENCE)
public class BODatabaseConfig {
    ...
    public LocalContainerEntityManagerFactoryBean boEntityManager() {
        ...
        em.setPackagesToScan("bg.duosoft.nacid.backoffice.rudi.be.domain",
                "bg.duosoft.nacid.backoffice.core.data.domain.entity",
                // TODO: NACIDSE-16
                "bg.duosoft.nacid.backoffice.rudi.be.grading.scales.entity");
