...
--changeset mnakova:0161.1
drop view regprof.vw_applications_list;

--changeset mnakova:0161.2 splitStatements:false
create or replace view regprof.vw_applications_list
            (id, ate_code, ase_code, entry_num, entry_date, efiling_id, external_system_id, applicant_name, applicant_civil_id,
             apn_status_name, apn_status_code,
             docflow_status_code, docflow_status_name, responsible_user_name, end_date, imi, service_type_id, application_prof_qualification)
as
SELECT apn.id,
       apn.ate_code,
       apn.ase_code,
       ...
       apt.civil_id         AS applicant_civil_id,
       ...
       ran.application_prof_qualification AS application_prof_qualification
