...
--changeset murlev:0147 splitStatements:false
...
WHERE acm.apn_id = ran.apn_id)                                           AS experts_count
  ...
  AND acm.process_status = 0
    ...
    tce.original_edu_level_translated                                         AS original_edu_level_translated,
    tce.manual_temp_uni_name                                                  AS manual_temp_uni_name,
