...
import bg.duosoft.nacidservicesbe.domain.entity.regprof.RegprofPostgraduateTrainingCourseEntity;
...
public abstract class ADQEducationMapper extends BaseObjectMapper<RegprofPostgraduateTrainingCourseEntity, RegprofEducationEntryDTO> {
    ...
    public abstract RegprofPostgraduateTrainingCourseEntity toEntity(RegprofEducationEntryDTO regprofEducationEntryDTO);

    @InheritInverseConfiguration(name = "toEntity")
    public abstract RegprofEducationEntryDTO toDto(RegprofPostgraduateTrainingCourseEntity regprofPostgraduateTrainingCourseEntity);
}
