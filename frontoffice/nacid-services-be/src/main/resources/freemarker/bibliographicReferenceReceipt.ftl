...
<#escape x as x?html>
    ...
    <#assign titleCode = "bibliographicReference.title.label" />
    <#assign showApplicantType = true />
    <#assign isOtherAttachments = true />
    ...
    <table class="bordered receiptTable">
        ...
        <#include "fragments/biblioReference/bibliographicReferenceDetailsFragment.ftl" />
