...
const InquiryCheckupPage = ({ titleCode }) => {
  ...
  return (
    <PageWrapper title={t(`${titleCode}.view`)}>
      <InquiryView
        serviceFn={getApplicationForCheckup(baseEndpointPaths.inquiry, dossierNumber, accessCode, captchaToken)}
      />
    </PageWrapper>
  );
};
export default InquiryCheckupPage;
