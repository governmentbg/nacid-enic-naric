...
const RegprofView = ({ serviceFn }: { serviceFn: () => Promise<any> }) => {
  ...
  useViewDataControl({
    viewType: ApplicationSubtype.REGULATED_PROFESSIONS,
  ...
  return (
    <AppPageContentWrapper>
      <Box sx={{ width: "100%" }}>
        <ViewContentWrapper viewType={ApplicationSubtype.REGULATED_PROFESSIONS} viewId={id ? id : dossierNumber}>
          <ViewRegprofApp
