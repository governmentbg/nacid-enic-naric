...
import bg.duosoft.nacidservicesbe.domain.entity.regprof.RegprofHigherTrainingCourseEntity;
...
public abstract class HigherEducationMapper extends BaseObjectMapper<RegprofHigherTrainingCourseEntity, RegprofEducationEntryDTO> {
    ...
    @Mapping(target = "educationLevel", source = "eduLevel")
    public abstract RegprofHigherTrainingCourseEntity toEntity(RegprofEducationEntryDTO regprofEducationEntryDTO);

    @InheritInverseConfiguration(name = "toEntity")
    public abstract RegprofEducationEntryDTO toDto(RegprofHigherTrainingCourseEntity regprofHigherTrainingCourseEntity);
