...
import { BoxedHeader, BoxSpg, GridContainer, GridItem, RelativeBox } from "@duosoftbg/nacid-components";
...
const ArrayFormControl = ({ field, initialValues, renderFormFields, addBtnLabelCode, subsequentTitleCode = null }) => {
  ...
  return (
    <>
      <BoxedHeader labelCode="t.dipolma.subjects.title"></BoxedHeader>
      <BoxSpg>
        <GridContainer spacing={1} mt={0}>
          <GridItem xs={11} sm={11} md={11.5}>
