...
const PublicAccessCheckupPage = ({ titleCode }) => {
  ...
  return (
    <PageWrapper title={t(`${titleCode}.view`)}>
      <InquiryView
        serviceFn={getApplicationForCheckup(baseEndpointPaths.publicAccess, dossierNumber, accessCode, captchaToken)}
      />
    </PageWrapper>
  );
};
export default PublicAccessCheckupPage;
