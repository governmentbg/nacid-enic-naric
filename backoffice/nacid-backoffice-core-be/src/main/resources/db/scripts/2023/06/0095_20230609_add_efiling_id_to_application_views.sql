...
--changeset akehayov:0095 splitStatements:false
drop view rudi.vw_applications_list;

create
or replace view rudi.vw_applications_list
            (id, ate_code, ase_code, entry_num, entry_date, efiling_id, applicant_name, university_name, university_country_name,
...
or replace view regprof.vw_applications_list
            (id, ate_code, ase_code, entry_num, entry_date, efiling_id, applicant_name, apn_status_name, apn_status_code,
             docflow_status_code, docflow_status_name, responsible_user_name, end_date, imi)
as
SELECT apn.id,
       apn.ate_code,
       apn.ase_code,
