package bg.duosoft.nacid.backoffice.rudi.be.config.swagger;
...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                .groupName("NACID Backoffice Rudi API")
                .apiInfo(apiInfo("REST API Documentation (NACID Backoffice Rudi API)"))
