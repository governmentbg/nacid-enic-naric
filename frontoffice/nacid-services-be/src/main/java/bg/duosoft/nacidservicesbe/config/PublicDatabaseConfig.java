...
@EnableJpaRepositories(
        basePackages = {"bg.duosoft.nacidservicesbe.repository", "bg.duosoft.email.nacidemailproducer.repository"},
...
public class PublicDatabaseConfig {
    ...
    public LocalContainerEntityManagerFactoryBean pdbEntityManager() {
        ...
        em.setPackagesToScan("bg.duosoft.nacidservicesbe.domain.entity", "bg.duosoft.nacidcoredata.domain.entity",
