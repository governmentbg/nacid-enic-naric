...
--changeset ggeorgiev:0129 splitStatements:false
--validCheckSum: 8:3e8602fb5a81d82eca80a9fd9b76c37a
--validCheckSum: 8:fb2bdbe876e29e8c71f6250f72514d66
...
select id, entry_num, entry_date, docflow_status_code, status_code, applicant_name, university_name, university_country_name, nullif(training_institution_name,'') training_institution_name, original_edu_level_name, original_speciality_name, original_qualification_name,
       recognized_speciality_name, recognized_edu_level, recognized_qualification_name, last_commission_calendar_date, last_commission_calendar_number, legal_reason_name,
...
from
    (SELECT apn.id,
            ...
            coalesce(tce.original_edu_level_translated, tce.original_edu_level_name)                                                                                        AS original_edu_level_name,
            ...
            ccr.session_num                                                                                                                                                 AS last_commission_calendar_number,
