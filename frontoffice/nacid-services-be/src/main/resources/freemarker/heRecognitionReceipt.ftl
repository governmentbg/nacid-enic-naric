...
<#escape x as x?html>
    ...
    <#assign titleCode = "heRecognition.title.label" />
    ...
    <table class="bordered receiptTable">
        ...
        <#include "fragments/diffDiplomaNamesFragment.ftl" />
        ...
        <#include "fragments/heRecognition/heEducationDetailsFragment.ftl" />
