...
public abstract class DocrecMainDataMapper extends MainDataMapperBase<DocrecMainDataDTO> {
    ...
    public abstract DocrecMainDataDTO toMainDataSection(RudiApplicationDTO application);

    @AfterMapping
    public void afterToMainDataSection(RudiApplicationDTO source, @MappingTarget DocrecMainDataDTO target) {
    ...
    public abstract void overrideApplicationData(DocrecMainDataDTO source, @MappingTarget RudiApplicationDTO target);

    @AfterMapping
    public void afterOverride(DocrecMainDataDTO source, @MappingTarget RudiApplicationDTO target) {
