...
import FoAdditionalDocumentsAppsList from "./FoAdditionalDocumentsAppsList";
...
import { FoAdditionalDocumentsFilterDetails } from "../../../../../../types/applications/electronicSubmission/foApplicationTypes";
import { vFoBaseAppsFilterSchema } from "../../../../../../yup/schema/applications/common/schemas";

const FoAdditionalDocumentsApps = () => {
  const group = SEARCH_FILTERS_GROUP.FO_ADDITIONAL_DOCUMENTS_APPLICATIONS;
  const store = useStore();

  const { methods, handleSubmit } = useReactHookForm<FoAdditionalDocumentsFilterDetails>({
    defaultValues: foAdditionalDocumentsFilterInitialValues,
  ...
  const control = useSearchTableControl({
    group,
    methods,
    initialValues: foAdditionalDocumentsFilterInitialValues,
...
export default FoAdditionalDocumentsApps;
